 ...
 */
public class MyListFragment extends Fragment implements CustomCursorAdapterClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        CustomCursorAdapter customCursorAdapter = new CustomCursorAdapter(getActivity(),cursor);
    ...
    public void didTapListViewAtIndex(int index) {
        if(getActivity() instanceof MainActivity){
            ...
            parent.didTapListViewAtIndex(index);
        }
    }
}